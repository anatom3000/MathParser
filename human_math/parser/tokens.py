...
class ParentheseOpen(SimpleExplcitToken):
    name = "("


class ParentheseClose(SimpleExplcitToken):
    name = ")"


class WildcardOpen(SimpleExplcitToken):
    name = "["


class WildcardClose(SimpleExplcitToken):
    name = "]"
